...
impl SharedPaths {
    ...
    /// # Examples
    /// ```no_run
    /// use marco_shared::paths::SharedPaths;
    ///
    /// # fn main() -> Result<(), marco_shared::paths::AssetError> {
    ...
    /// In install mode: $XDG_CONFIG_HOME/markdowncomposer/settings.ron on Linux
    /// (or portable: ./config/settings.ron)
