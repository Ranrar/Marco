...
*nom*
: A parser combinator library for Rust. Used in `core/src/grammar/` to build Marco's hand-crafted Markdown parser.
...
: Abstract Syntax Tree — a tree-like data structure that represents the syntactic
  ...
  Marco's AST is defined in `core/src/parser/ast.rs`.
