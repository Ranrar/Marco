//! Toolbar slider-deck button connector
//!
//! Connects the modules → Slider deck button to show the Insert Slider Deck dialog.

use gtk4::prelude::*;
use sourceview5::{Buffer, View};

pub fn connect_slider_deck_toolbar_action(
    toolbar: &gtk4::Box,
