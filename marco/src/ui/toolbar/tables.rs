//! Toolbar table button connector
//!
//! Connects the modules -> table button to show the Insert Table dialog.

use gtk4::prelude::*;
use sourceview5::{Buffer, View};

pub fn connect_table_toolbar_action(
    toolbar: &gtk4::Box,
    ...
    if let Some(button) =
        find_button_by_css_class(toolbar.upcast_ref::<gtk4::Widget>(), "toolbar-btn-table")
    {
        ...
        button.connect_clicked(move |_| {
            ...
            crate::ui::dialogs::tables::show_insert_table_dialog(
