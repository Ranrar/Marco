//! Toolbar mermaid-diagram button connector
//!
//! Connects the modules → Mermaid button to show the Insert Mermaid Diagram dialog.

use gtk4::prelude::*;
use sourceview5::{Buffer, View};

pub fn connect_mermaid_toolbar_action(
    toolbar: &gtk4::Box,
    ...
    if let Some(button) =
        find_button_by_css_class(toolbar.upcast_ref::<gtk4::Widget>(), "toolbar-btn-mermaid")
    {
