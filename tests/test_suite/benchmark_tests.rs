...
pub fn run_performance_benchmarks(iterations: usize, custom_file: Option<&str>) {
    ...
    if let Some(file_path) = custom_file {
        ...
        let (parse_stats, render_stats, full_stats) =
            benchmark_document(&content, file_path, iterations);
        ...
        println!(
            "Parse:          {}",
            BenchmarkStats::format_duration(parse_stats.median)
        );
        println!(
            "Render:         {}",
            BenchmarkStats::format_duration(render_stats.median)
        );
        println!(
            "Parse + Render: {}",
            BenchmarkStats::format_duration(full_stats.median)
        );
        println!();
        println!(
            "Throughput: {} MB/s",
    ...
    let (small_parse, small_render, small_full) =
        benchmark_document(small_doc, "Small Document", iterations);
    let (medium_parse, medium_render, medium_full) =
        benchmark_document(medium_doc, "Medium Document", iterations);
    let (large_parse, large_render, large_full) =
        benchmark_document(large_doc, "Large Document", iterations);
    ...
    println!(
        "  Small:  {}/iteration",
        BenchmarkStats::format_duration(small_parse.median)
    );
    println!(
        "  Medium: {}/iteration",
        BenchmarkStats::format_duration(medium_parse.median)
    );
    println!(
        "  Large:  {}/iteration",
        BenchmarkStats::format_duration(large_parse.median)
    );
    println!();
    ...
    println!(
        "  Small:  {}/iteration",
        BenchmarkStats::format_duration(small_render.median)
    );
    println!(
        "  Medium: {}/iteration",
        BenchmarkStats::format_duration(medium_render.median)
    );
    println!(
        "  Large:  {}/iteration",
        BenchmarkStats::format_duration(large_render.median)
    );
    println!();
