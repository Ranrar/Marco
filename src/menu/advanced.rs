...
use gtk4::prelude::*;
use gtk4::{gio, Application, MessageDialog, MessageType, ResponseType};
...
pub fn add_advanced_menu(menu_model: &gio::Menu) {
    ...
    advanced_menu.append_submenu(
        Some(&language::tr("advanced.text_styling")),
        &text_styling_menu,
    );
    ...
    advanced_menu.append_submenu(
        Some(&language::tr("advanced.comments_admonitions")),
        &comments_menu,
    );
    ...
    media_menu.append(
        Some("🖼️ Image with Size"),
        Some("app.insert_image_with_size"),
    );
    media_menu.append(
        Some("🖼️ Image with Caption"),
        Some("app.insert_image_with_caption"),
    );
    ...
    advanced_menu.append(
        ...
        Some("app.insert_table_of_contents"),
    );
...
pub fn create_advanced_actions(app: &Application, editor: &editor::MarkdownEditor) {
    ...
    app.add_action_entries([
        ...
        insert_center_text_action,
        insert_colored_text_action,
        insert_indent_text_action,
        insert_comment_action,
        insert_admonition_action,
        insert_image_with_size_action,
        insert_image_with_caption_action,
        insert_link_open_new_action,
        insert_youtube_video_action,
        insert_table_of_contents_action,
    ]);
}
