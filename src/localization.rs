...
fn load_translations() {
    ...
    let en_path = base_path.join("locales/en/main.yml");
    ...
    let es_path = base_path.join("locales/es/main.yml");
    ...
    let fr_path = base_path.join("locales/fr/main.yml");
    ...
    let de_path = base_path.join("locales/de/main.yml");
