...
impl ContextMenu {
    ...
    fn create_menu_model() -> gio::Menu {
        ...
        selection_section.append(Some(&language::tr("menu.select_all")), Some("app.select_all"));
        ...
        formatting_section.append(Some(&language::tr("insert.italic")), Some("app.insert_italic"));
        formatting_section.append(Some(&language::tr("insert.strikethrough")), Some("context.strikethrough"));
        formatting_section.append(Some(&language::tr("insert.inline_code")), Some("app.insert_inline_code"));
